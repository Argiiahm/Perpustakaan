                    ...
                    <div class="my-5">
                        ...
                        <select name="jenis_kelamin"
                            ...
                            <option value="" disabled
                                {{ old('jenis_kelamin', Auth::user()->Anggota->jenis_kelamin ?? '') == '' ? 'selected' : '' }}>
                                Pilih Jenis Kelamin
                            </option>

                            <option value="Laki-laki"
                                {{ old('jenis_kelamin', Auth::user()->Anggota->jenis_kelamin ?? '') == 'Laki-laki' ? 'selected' : '' }}>
                                Laki-laki
                            </option>

                            <option value="Perempuan"
                                {{ old('jenis_kelamin', Auth::user()->Anggota->jenis_kelamin ?? '') == 'Perempuan' ? 'selected' : '' }}>
                                Perempuan
                            </option>
